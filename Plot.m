...
%          
          plotwaypoint2 = scatter(NavData(1:57,1),NavData(1:57,2),5,'filled','b'); %Arr WP
          txt2a = text(NavData(1:57,1),NavData(1:57,2),label(1:57,1),'FontSize',5,'HorizontalAlignment','right');
