function [y] = clearance(ROW,conflict,airplane,j,distance,buffer_zone_1,buffer_zone_2,height,hold_status)
...
elseif conflict(1,j) == 1 
    if column1 == 1
       ...
       k = it_2(1,column1-1);
       if it_2(2,column1-1) == 0 && distance(j,k) > buffer_zone
           y = 1;
       elseif it_2(2,column1-1) == 1 && distance(j,k) > buffer_zone
           y = 1;
       elseif it_2(2,column1-1) == 0 && distance(j,k) < buffer_zone
           y = 1;
       elseif it_2(2,column1-1) == 1 && distance(j,k) < buffer_zone
           y = 0;
       end
